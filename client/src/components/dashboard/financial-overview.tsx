        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1 pr-4">
              ...
              <p className="text-3xl font-bold tracking-tight leading-tight modern-large-value" data-testid="balance-total">
                {formatCurrency(balance)}
              </p>
            </div>
            <div className="bg-blue-400/30 rounded-xl p-3 backdrop-blur-sm flex-shrink-0 self-start">
        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1 pr-4">
              ...
              <p className="text-3xl font-bold text-green-600 tracking-tight leading-tight modern-large-value" data-testid="income-total">
                {formatCurrency(totalIncome)}
              </p>
            </div>
            <div className="bg-green-100 dark:bg-green-900 rounded-xl p-3 flex-shrink-0 self-start">
        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1 pr-4">
              ...
              <p className="text-3xl font-bold text-red-600 tracking-tight leading-tight modern-large-value" data-testid="expenses-total">
                {formatCurrency(totalExpenses)}
              </p>
            </div>
            <div className="bg-red-100 dark:bg-red-900 rounded-xl p-3 flex-shrink-0 self-start">
        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1 pr-4">
              ...
              <p className="text-3xl font-bold text-purple-600 tracking-tight leading-tight modern-large-value" data-testid="investments-total">
                {formatCurrency(investmentValue)}
              </p>
            </div>
            <div className="bg-purple-100 dark:bg-purple-900 rounded-xl p-3 flex-shrink-0 self-start">
